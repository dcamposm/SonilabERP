...
Route::get('/estadillos/mostrar/{id}', 'EstadilloController@show')->name('estadilloShow');
...
Route::get('/estadillos/actor/crear/{id}', 'EstadilloController@insertActorView')->name('estadilloActorInsertView');
...
Route::get('/estadillos/modificar/actor/{id}', 'EstadilloController@updateActorView')->name('estadilloActorUpdateView');
Route::post('/estadillos/modificar/{id}', 'EstadilloController@update')->name('estadilloUpdate');
Route::post('/estadillos/modificar/actor/{id}', 'EstadilloController@updateActor')->name('estadilloActorUpdate');

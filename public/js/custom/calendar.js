        ...
        for (var i = 0; i < 8; i++) {
            ...
            for (var h = 0; h < 5; h++) {
                    var festiu = festius.filter(function(e) {
                        if (e.data == dias[h] && e.num_sala == sala){
                            return e;
                        }
                    })
                    ...
                    fila.append('<div class="col celda" dia="' + dias[h] + '" sala="' + sala + '" style=" min-height: 200px;">\n\
                                    <div class="row rowMati">\n\
                                        <div class="col colGlob">\n\
                                            <div class="row det">\n\
                                                <div class="viewTecnic" style="'+ (!tecnicMati[0]  ? '' : (!tecnicMati[0].empleat ? 'border-left: 1px solid black;' : 'background-color: '+tecnicMati[0].empleat.color_empleat+';'+(tecnicMati[0].empleat.color_empleat == '#000000' ? 'color: #FFFFFF' : 'color: #000000')+'; border-right: 1px solid black;')) +'"><div class="rotar">'+ (!tecnicMati[0] ? '' : (!tecnicMati[0].empleat ? '' : (tecnicMati[0].empleat.nom_empleat).split(' ')[0])) +'</div></div>\n\
                                    ...
                                    <div class="row rowTarda">\n\
                                        <div class="col colGlob">\n\
                                            <div class="row det">\n\
                                                <div class="viewTecnic" style="'+ (!tecnicTarda[0] ? '' : (!tecnicTarda[0].empleat ? 'border-left: 1px solid black;' : 'background-color: '+tecnicTarda[0].empleat.color_empleat+';'+(tecnicTarda[0].empleat.color_empleat == '#000000' ? 'color: #FFFFFF' : 'color: #000000')+'; border-right: 1px solid black;')) +'"><div class="rotar">'+ (!tecnicTarda[0] ? '' : (!tecnicTarda[0].empleat ? '' : (tecnicTarda[0].empleat.nom_empleat).split(' ')[0])) +'</div></div>\n\
        ...
        $.each(data, function( key, element ) {   
            if (element.data_inici.split(' ')[1] <= '13:30') {
                var actorSala = '<div class="row '+(element.asistencia === 0 ? 'actorNoPres' : '')+'">\
                                    ...
                                    <div class="col-5 llistaActors" style="padding-left: 5px; padding-right: 5px; '+(!element.registre_entrada || element.asistencia === 0 ? '' : ('background-color: '+element.registre_entrada.color_referencia+';'))+'">'+element.referencia_titol+'</div>\n\

...
<div class="container">
    ...
    <h2 style="font-weight: bold">{{ $estadillos->registreEntrades->titol }} {{ $estadillos->id_registre_produccio == 0 ? '' : $estadillos->id_registre_produccio }}</h2>
    <table class="table" style="margin-top: 10px;">
        ...
        <tbody>
            ...
            <tr class="table-selected">
                ...
                <td style="vertical-align: middle;">
                    <a href="{{ route('estadilloActorUpdateView', array('id' => $actor['id'])) }}" class="btn btn-primary">Modificar</a>

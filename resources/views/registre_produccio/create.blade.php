            ...
            <div class="form-group col-12 col-sm-6">
              ...
              <select name="id_registre_entrada" id="id_registre_entrada" class="form-control">
                @foreach ($regEntrades as $key => $entrada) 
                  <option value="{{ $entrada->id_registre_entrada }}" {{(!empty($registreProduccio) && $entrada->id_registre_entrada == $registreProduccio->id_registre_entrada) ? 'selected' : '' }} >{{ $entrada->id_registre_entrada }} {{ $entrada->titol }}</option>
                @endforeach
              </select>
            </div>
          ...
          <div class="card-body row">
            ...
            <div class="form-group col-12 col-sm-6">
              ...
              <select name="pps" id="pps" class="form-control">
                <option value="0" {{(!empty($registreProduccio) && "0" == $registreProduccio->pps) ? 'selected' : '' }}>No</option>
                <option value="1" {{(!empty($registreProduccio) && "1" == $registreProduccio->pps) ? 'selected' : '' }}>Sí</option>
              </select>
            </div>
      ...
      <div class="card">
        <form method="POST" action="{{!empty($registreProduccio) ? route('updateRegistreConvocatoria',array('id' => $registreProduccio->id)) : route('createRegistreConvocatoria')}}"> {{-- init form --}}
            ...
            <div class="form-group col-12 col-sm-6">
              ...
              <input type="date" name="final_sala" id="inici_sala" class="form-control" value={{!empty($registreProduccio) ? explode(' ', $registreProduccio->final_sala)[0] : ''}}>
            </div>           

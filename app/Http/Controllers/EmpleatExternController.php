    ...
    public function show($id)
    {
        ...
        foreach ($carrecs as $key => $carrec) {
            ...
            $carrecsEmpelat[$carrec->carrec->nom_carrec][$carrec->id] = array(
                ...
                'preu_carrec1' => $carrec->preu_carrec1,
                'preu_carrec2' => $carrec->preu_carrec2,
                'preu_docu' => $carrec->preu_docu,
                'preu_video_tk' =>$carrec->preu_video_tk,
                'preu_video_cg' => $carrec->preu_video_cg,
                'preu_cine_tk' => $carrec->preu_cine_tk,
                'preu_cine_cg' => $carrec->preu_cine_cg,
            );
        }
        ...
        foreach ($carrecsEmpleats as $key => $carrecEmp) {
            if ($carrecEmp->id_idioma == 0) {
                $carrecsData[$carrecEmp->carrec->input_name] = array(
                    'preu_carrec1' => $carrecEmp->preu_carrec1,
                    'preu_carrec2' => $carrecEmp->preu_carrec2,
                );
            } else {
                $carrecsData[$carrecEmp->carrec->input_name][$carrecEmp->idioma->idioma] = array(
                    ...
                    'preu_carrec1' => $carrecEmp->preu_carrec1,
                    'preu_carrec2' => $carrecEmp->preu_carrec2,
                    'preu_docu' => $carrecEmp->preu_docu,
                    'preu_video_tk' => $carrecEmp->preu_video_tk,
                    'preu_video_cg' => $carrecEmp->preu_video_cg,
                    'preu_cine_tk' => $carrecEmp->preu_cine_tk,
                    'preu_cine_cg' => $carrecEmp->preu_cine_cg,
                );
            }
        }
            ...
            if ($empleat) {
                ...
                foreach ($camposCargos as $key => $carrec) {
                    ...
                    if (($nomCarrec == "director" || $nomCarrec == "tecnic_sala") && request()->has($nomCarrec)) {
                        ...
                        $datos["preu_carrec1"] = (request()->has("preu1_$nomCarrec")) ? request()->input("preu1_$nomCarrec") : 0;
                        $datos["preu_carrec2"] = (request()->has("preu2_$nomCarrec")) ? request()->input("preu2_$nomCarrec") : 0;
                        ...
                        foreach ($idiomas as $key => $idioma) {
                            ...
                            if (request()->has("idioma_$nomCarrec" . "_$nom_idioma")) {
                                ...
                                $datos["preu_carrec1"] = (request()->has("preu1_$nomCarrec" . "_$nom_idioma")) ? request()->input("preu1_$nomCarrec" . "_$nom_idioma") : 0;
                                $datos["preu_carrec2"] = (request()->has("preu2_$nomCarrec" . "_$nom_idioma")) ? request()->input("preu2_$nomCarrec" . "_$nom_idioma") : 0;
                                $datos["preu_docu"] = (request()->has("preu_docu_$nomCarrec" . "_$nom_idioma")) ? request()->input("preu_docu_$nomCarrec" . "_$nom_idioma") : 0;
                                $datos["preu_video_tk"] = (request()->has("preu_video_tk_$nomCarrec" . "_$nom_idioma")) ? request()->input("preu_video_tk_$nomCarrec" . "_$nom_idioma") : 0;
                                $datos["preu_video_cg"] = (request()->has("preu_video_cg_$nomCarrec" . "_$nom_idioma")) ? request()->input("preu_video_cg_$nomCarrec" . "_$nom_idioma") : 0;
                                $datos["preu_cine_tk"] = (request()->has("preu_cine_tk_$nomCarrec" . "_$nom_idioma")) ? request()->input("preu_cine_tk_$nomCarrec" . "_$nom_idioma") : 0;
                                $datos["preu_cine_cg"] = (request()->has("preu_cine_cg_$nomCarrec" . "_$nom_idioma")) ? request()->input("preu_cine_cg_$nomCarrec" . "_$nom_idioma") : 0;
                    ...
                    if (($nomCarrec == "director" || $nomCarrec == "tecnic_sala") && request()->has($nomCarrec)) {
                        ...
                        foreach ($idiomas as $key => $idioma) {
                            ...
                            if (request()->has("idioma_$nomCarrec" . "_$nom_idioma")) {
                                ...
                                // return response()->json(request()->has("homologat_$nomCarrec" . "_$nom_idioma"), 400);
                                if (empty($carrecAntic)){
                                    $carrecEmpleat = new CarrecEmpleat($datos);
                                    // TODO: Validar "carrecEmpleat"
                                    $carrecEmpleat->save();
